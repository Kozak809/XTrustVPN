package com.kozak.xtrustvpn.utils
...
import com.kozak.xtrustvpn.ui.BlankActivity
...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "XTrustVPN for Android ${SagerNet.appVersionNameForDisplay} (${BuildConfig.VERSION_CODE})\n"
