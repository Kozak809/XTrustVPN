...
import com.kozak.xtrustvpn.*
import com.kozak.xtrustvpn.bg.VpnService
import com.kozak.xtrustvpn.database.DataStore
import com.kozak.xtrustvpn.database.ProxyEntity
import com.kozak.xtrustvpn.database.ProxyEntity.Companion.TYPE_CONFIG
import com.kozak.xtrustvpn.database.SagerDatabase
import com.kozak.xtrustvpn.fmt.ConfigBuildResult.IndexEntity
import com.kozak.xtrustvpn.fmt.hysteria.HysteriaBean
import com.kozak.xtrustvpn.fmt.hysteria.buildSingBoxOutboundHysteriaBean
import com.kozak.xtrustvpn.fmt.internal.ChainBean
import com.kozak.xtrustvpn.fmt.shadowsocks.ShadowsocksBean
import com.kozak.xtrustvpn.fmt.shadowsocks.buildSingBoxOutboundShadowsocksBean
import com.kozak.xtrustvpn.fmt.socks.SOCKSBean
import com.kozak.xtrustvpn.fmt.socks.buildSingBoxOutboundSocksBean
import com.kozak.xtrustvpn.fmt.ssh.SSHBean
import com.kozak.xtrustvpn.fmt.ssh.buildSingBoxOutboundSSHBean
import com.kozak.xtrustvpn.fmt.tuic.TuicBean
import com.kozak.xtrustvpn.fmt.tuic.buildSingBoxOutboundTuicBean
import com.kozak.xtrustvpn.fmt.v2ray.StandardV2RayBean
import com.kozak.xtrustvpn.fmt.v2ray.buildSingBoxOutboundStandardV2RayBean
import com.kozak.xtrustvpn.fmt.wireguard.WireGuardBean
import com.kozak.xtrustvpn.fmt.wireguard.buildSingBoxOutboundWireguardBean
import com.kozak.xtrustvpn.ktx.isIpAddress
import com.kozak.xtrustvpn.ktx.mkPort
