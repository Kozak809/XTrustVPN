...
object AppConfig {
    ...
    const val PREF_BAD_AUTOCONNECT_KEYS = "pref_bad_autoconnect_keys"
    ...
    const val APP_URL = "$GITHUB_URL/2dust/XTrustVPN"
    const val APP_API_URL = "https://api.github.com/repos/2dust/XTrustVPN/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/XTrustVPN/master/CR.md"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val MSG_MEASURE_DELAY_RESULT = 62
    ...
    const val RAY_NG_CHANNEL_NAME = "XTrustVPN Background Service"
